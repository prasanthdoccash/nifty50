...
predefined_symbols123 = [ "RELIANCE", "TCS", "HDFCBANK", "INFY", "ICICIBANK", "HINDUNILVR", "ITC", "KOTAKBANK", "SBIN", "BAJFINANCE",
    ...
    "BRITANNIA", "GAIL", "DABUR", "SRTRANSFIN", "SIEMENS", "HINDALCO", "ICICIPRULI", "SBICARD", "ABBOTINDIA",
    ...
    "IOC", "IDFCFIRSTB", "JUBLFOOD", "ACC", "COLPAL", "MINDTREE", "APOLLOHOSP", "GODREJCP", "CHOLAFIN", "PAGEIND",
    "NAUKRI", "CONCOR", "ICICIGI", "NMDC", "MFSL", "IIFL", "TATACHEM", "ASTRAL", "AUBANK", "JINDALSTEL", "BHEL",
    "GODREJPROP", "ASHOKLEY", "PNB", "CANBK", "TRENT", "SUNTV", "VOLTAS", "DALBHARAT", "LTI", "METROPOLIS", "POLYCAB",
    "PETRONET", "ADANITRANS", "BAJAJELEC", "MGL", "IGL", "MRF", "BERGEPAINT", "PIIND", "DLF", "INDHOTEL", "PVR",
    "SRF", "SUNDARMFIN", "ZEEL", "IDBI", "INDIANB", "EXIDEIND", "AIAENG", "ALEMBICLTD", "ALKEM", "ALOKINDS",
    "AMARAJABAT", "APOLLOTYRE", "ARVIND", "ASHOKA", "BALKRISIND", "BEML", "BHARATFORG", "BIOCON", "BLISSGVS",
    "BLUEBLENDS", "BOSCHLTD", "CADILAHC", "CANFINHOME", "CARBORUNIV", "CASTROLIND", "CESC", "CIPLA", "COROMANDEL",
    ...
    "JYOTHYLAB", "KALPATPOWR", "KARURVYSYA", "KEC", "KNRCON", "KOTAKBANK", "KRBL", "L&TFH", "LALPATHLAB", "LICHSGFIN",
    "LTTS", "LUXIND", "MAHINDCIE", "MAHSCOOTER", "MARICO", "MCX", "METROPOLIS", "MGL", "MINDAIND", "MPHASIS", "MRPL",
    ...
    "STLTECH", "SUNPHARMA", "SUNTV", "SUPRAJIT", "SYMPHONY", "TATACHEM", "TATAELXSI", "TATACOFFEE", "TATACOMM",
